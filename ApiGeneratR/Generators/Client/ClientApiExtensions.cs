...
{
    public static void CreateApiContainer(this SourceProductionContext ctx, GlobalOptions options,
        TranspilerBuilder transpilerBuilder, string projectNamespace)
    {
        ...
        AddSource(ctx, "ApiContainer.g.cs", scb.ToString(), options, transpilerBuilder);
    }

    public static void CreateClientApiExtensions(this SourceProductionContext ctx, GlobalOptions options,
        ImmutableArray<RequestData> requests, TranspilerBuilder transpilerBuilder, string projectNamespace)
    {
        var scb = new SourceCodeBuilder();
        ...
        AddSource(ctx, "ApiContainerExtensions.g.cs", scb.ToString(), options, transpilerBuilder);
    }

    public static void GenerateWebsocketReceiver(this SourceProductionContext ctx, GlobalOptions options,
        ImmutableArray<EventData> events, TranspilerBuilder transpilerBuilder, string projectNamespace)
    {
        var scb = new SourceCodeBuilder();
        scb.SetUsings([
        ...
        AddSource(ctx, "WebSocketService.g.cs", scb.ToString(), options, transpilerBuilder);
    }

    public static void CreateTokenInjectorBaseClass(this SourceProductionContext context, GlobalOptions options,
        ...
        TranspilerBuilder transpilerBuilder)
    {
        ...
        AddSource(context, "TokenInjection.g.cs", scb.ToString(), options, transpilerBuilder);
    }

    public static void CreateAtomicRequestSenderWithInterfaces(this SourceProductionContext context,
        ImmutableArray<RequestData> requests, GlobalOptions options,
        TranspilerBuilder transpilerBuilder, string projectNamespace)
    {
        foreach (var request in requests)
        {
            ...
            AddSource(context, $"Generated{request.RequestShortName}Sender.g.cs", scb.ToString(), options,
                transpilerBuilder);
        }
    }

    public static void CreateCommandSenderFacade(this SourceProductionContext context, GlobalOptions options,
        ImmutableArray<RequestData> requests, string projectNamespace, TranspilerBuilder transpilerBuilder)
    {
        context.InternalCreateRequestSenderFacades(options, requests, projectNamespace, "Command", transpilerBuilder);
    }

    public static void CreateQuerySenderFacade(this SourceProductionContext context, GlobalOptions options,
        ImmutableArray<RequestData> requests, string projectNamespace, TranspilerBuilder transpilerBuilder)
    {
        context.InternalCreateRequestSenderFacades(options, requests, projectNamespace, "Query", transpilerBuilder);
    }

    private static void InternalCreateRequestSenderFacades(this SourceProductionContext context, GlobalOptions options,
        ImmutableArray<RequestData> requests, string projectNamespace, string type, TranspilerBuilder transpilerBuilder)
    {
        ...
        AddSource(context, $"{type}Sender.g.cs", scb.ToString(), options, transpilerBuilder);
    }

    public static void CreateWebsocketInterface(this SourceProductionContext context, GlobalOptions options,
        TranspilerBuilder transpilerBuilder, string projectNamespace)
    {
        var scb = new SourceCodeBuilder();
        ...
        AddSource(context, "IEventReceiver.g.cs", scb.ToString(), options, transpilerBuilder);
    }

    public static void CreateApiClientWithInterface(this SourceProductionContext context, GlobalOptions options,
        TranspilerBuilder transpilerBuilder, string projectNamespace)
    {
        var scb = new SourceCodeBuilder();
        scb.SetUsings(["System.Net.Http"]);
        ...
        AddSource(context, "ApiClient.g.cs", scb.ToString(), options, transpilerBuilder);
    }
        ...
        GlobalOptions options, TranspilerBuilder transpilerBuilder)
    {
        ...
        AddSource(context, "EventBus.g.cs", scb.ToString(), options, transpilerBuilder);
    }
        ...
        GlobalOptions options, TranspilerBuilder transpilerBuilder)
    {
        ...
        {
            transpilerBuilder.AddFile(fileName, sourceCode);
        }
